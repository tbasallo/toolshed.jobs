...
namespace Toolshed.Jobs
{
    internal static class JobServiceHelper
    {
        ...
        internal static async Task DeleteAllEntitiesInBatchesAsync(CloudTable table, string partitionKey)
        {
            void processor(IEnumerable<DynamicTableEntity> entities)
            {
                var batches = new Dictionary<string, TableBatchOperation>();
        ...
        internal static void ProcessEntities(CloudTable table, Action<IEnumerable<DynamicTableEntity>> processor, string partitionKey)
        {
        ...
        internal static async Task ProcessEntitiesAsync(CloudTable table, Action<IEnumerable<DynamicTableEntity>> processor, string partitionKey)
        {
            TableQuerySegment<DynamicTableEntity> segment = null;
